    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_Query_Click(object sender, EventArgs e)
        {
            if (cb_SearchWay.SelectedItem != null && tb_SearchInfo.Text != "")
            {
                ...
                if (searchWay.Contains("客户名"))
                {
                    ...
                    orderBindingSource.DataSource = service.QueryOrderByCustomer(customerName);
                }
                ...
                if (searchWay.Contains("订单号"))
                {
                    ...
                    {
                        orderBindingSource.DataSource = service.QueryOrderById(Int32.Parse(tb_SearchInfo.Text));
                    }
                }
                if (searchWay.Contains("订单总额"))
                {
                    ...
                    if (reg.IsMatch(tb_SearchInfo.Text))
                    {
                        orderBindingSource.DataSource = service.QueryOrderByTotalPrice(Int32.Parse(tb_SearchInfo.Text));
                    }
                }
            }
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            if(o!=null)
            {
                ...
                {
                    service.ModifyOrder(o.ID,newOrderForm.order);
                }
                newOrderForm.Close();
            }
        }
        ...
        private void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            if(newOrderForm.DialogResult==DialogResult.OK)
            {
                service.AddOrder(newOrderForm.order);
                orderBindingSource.DataSource = null;
                orderBindingSource.DataSource = service.OrderList;
            }
            newOrderForm.Close();
